...
function contarFs(texto) {
  ...
  return `El texto proporcionado contiene ${letterCounter} Fs`;
};

console.log(contarFs('lalalalalFllalalalFlalalalaflalalalalF'));
...
console.log(contarCaracteres('lalalalalFllalalalFlalalalaflalalalalF', 'f'));
